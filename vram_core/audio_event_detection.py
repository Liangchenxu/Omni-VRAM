"""
Audio Event Detection (AED) Module for Omni-VRAM
==================================================
...
try:
    ...
    logger.info("TensorFlow detected — YAMNet backend available")
except ImportError:
    try:
        import tflite_runtime.interpreter as tflite
        _YAMNET_AVAILABLE = True
        logger.info("TFLite Runtime detected — YAMNet backend available")
    except ImportError:
