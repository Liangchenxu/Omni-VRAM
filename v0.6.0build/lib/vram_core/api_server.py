...
def create_app(
    ...
    app = FastAPI(
        title="Omni-VRAM Transcription API",
        description="High-performance speech-to-text API powered by Omni-VRAM",
        version="1.0.0",
    )
    ...
    async def root():
        ...
        return {
            "name": "Omni-VRAM Transcription API",
            "version": "1.0.0",
            "docs": "/docs",
            "health": "/health",
            "endpoints": {
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Omni-VRAM Transcription API Server",
...
Examples:
    ...
    logger.info(f"Starting Omni-VRAM API server...")
